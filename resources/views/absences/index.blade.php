...
<div class="row">
	<div class="col-lg-5">
		<div class="panel panel-default">	
			...
			<div class="panel-body"> 
				<div class="col-md-12">
					<form name="form_calendrier" id="form_calendrier" method="post" action="{{ route('absences.selectCal') }}">
						{!! csrf_field() !!}
						{{ method_field('POST') }}
	...
	<div class="col-lg-7">
		<div class="panel panel-default">	
			...
			<div class="panel-body"> 
				<div class="col-md-12">
					 <form name="formAbsencesEtudiants" method="post" action="{{ route('absences.store') }}" class="form-horizontal panel"  enctype = "multipart/form-data">
					 	{!! csrf_field() !!}
					 	{{ method_field('POST') }}
					 	...
					 	<div class="row">
					 		...
					 		<div class="col-md-7"><input type="text" class="form-control" name="motif_{!! $candidat->id !!}" placeholder="Motif absence"></div>
					 		<div class="col-md-1"></div>
					 		<div class="col-md-11"><input type="file" name="justif_{!! $candidat->id !!}" placeholder="justificatif"></div>
					 	</div>
					 	@endforeach
					 	<br />
					 	<input type="submit" value="Marquer comme absent" class="btn btn-default pull-right">
					 </form>				
				</div>
			</div>
		</div>
